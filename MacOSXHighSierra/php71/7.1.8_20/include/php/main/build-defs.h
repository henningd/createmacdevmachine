...
#define PHP_EXTENSION_DIR       "/usr/local/Cellar/php71/7.1.8_20/lib/php/extensions/no-debug-non-zts-20160303"
#define PHP_PREFIX              "/usr/local/Cellar/php71/7.1.8_20"
#define PHP_BINDIR              "/usr/local/Cellar/php71/7.1.8_20/bin"
#define PHP_SBINDIR             "/usr/local/Cellar/php71/7.1.8_20/sbin"
#define PHP_MANDIR              "/usr/local/Cellar/php71/7.1.8_20/share/man"
#define PHP_LIBDIR              "/usr/local/Cellar/php71/7.1.8_20/lib/php"
#define PHP_DATADIR             "/usr/local/Cellar/php71/7.1.8_20/share/php"
